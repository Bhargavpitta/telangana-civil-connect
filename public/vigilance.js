...
for (let i = 0; i < vigilanceReportData.length; i++) {
  if (vigilanceReportData[i].district !== null) reportTotalDistrict += vigilanceReportData[i].district;
  if (vigilanceReportData[i].mandalLevel !== null) reportTotalMandal += vigilanceReportData[i].mandalLevel;
  if (vigilanceReportData[i].gpLevel !== null) reportTotalGP += vigilanceReportData[i].gpLevel;
  if (vigilanceReportData[i].fpShopLevel !== null) reportTotalFP += vigilanceReportData[i].fpShopLevel;
}
...
for (let i = 0; i < vigilanceMeetingData.length; i++) {
  if (vigilanceMeetingData[i].district !== null) meetingTotalDistrict += vigilanceMeetingData[i].district;
  if (vigilanceMeetingData[i].mandalLevel !== null) meetingTotalMandal += vigilanceMeetingData[i].mandalLevel;
  if (vigilanceMeetingData[i].gpLevel !== null) meetingTotalGP += vigilanceMeetingData[i].gpLevel;
  if (vigilanceMeetingData[i].fpShopLevel !== null) meetingTotalFP += vigilanceMeetingData[i].fpShopLevel;
}
