        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/" element={<Layout />}>
              ...
              <Route path="administration/org-chart" element={<OrganisationCharts />} />
            ...
            {/* Citizen */}
            <Route path="/services/ration-status" element={<KnowRationStatus />} />
            <Route path="/services/epos-transactions" element={<EposTransactions />} />
            ...
            <Route path="/videos/consumer-awareness" element={<VideoGallery />} />
